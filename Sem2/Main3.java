...
public class Main3 {
    ...
    И метод, который запишет эту строку в простой текстовый файл, обрабатывайте исключения.
     */
    ...
    private static void createLogger() {
        ...
        try {
            fileHandler = new FileHandler("Sem2/log.txt", true);
    ...
    static void writeToFile(String s1, String filePath) {
        ...
        try {
            ...
            e.printStackTrace();
            logger.info("Не удалось записать в файл");
        }
    }
